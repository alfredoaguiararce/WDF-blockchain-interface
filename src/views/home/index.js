...
import usePlatziPunks from "../../hooks/useNFT";
  ...
  return (
    ...
    >
      <Stack flex={1} spacing={{ base: 5, md: 10 }}>
        ...
        <Text color={"gray.500"}>
          Esta coleccion de Avatares randomizados cuya metadata
          es almacenada on-chain. Poseen características únicas y sólo hay 10000
          en existencia.
        </Text>
        <Text color={"purple.500"}>
          Cada NFT se genera de forma secuencial basado en tu address,
          usa el previsualizador para averiguar cuál sería tu NFT si
